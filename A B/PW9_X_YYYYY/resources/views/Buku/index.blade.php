    ...
    <body>
        ...
        <center>
            <div class="card text-center">
                <p class="card-title">Buku Saya</p>
            </div>
        </center>
        ...
        <div class="container">
            ...
            <table class="table table-hover text-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->status }}</td>
                        <td>
                            <a href="{{ route('buku.edit', $item->id_buku) }}" onclick="return confirm('Apakah Anda yakin ingin mengedit item ini?')">
                                <i class="fa fa-pencil" style="margin-right: 10px;"></i>
                            </a>
                            <a href="{{ route('buku.delete', $item->id_buku) }}" onclick="return confirm('Apakah Anda yakin ingin menghapus item ini?')">
            ...
            <div class="d-flex justify-content-center">{{$buku->links()}}</div>
        </div>
