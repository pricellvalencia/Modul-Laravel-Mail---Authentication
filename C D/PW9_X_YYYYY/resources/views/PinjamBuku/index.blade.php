    ...
    <body>
        ...
        <center>
            <div class="card text-center">
                <p class="card-title">Pinjam Buku</p>
            </div>
        </center>
            ...
            <table class="table table-hover text-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->penerbit }}</td>
                        <td>
                            <form method="POST" action="{{ route('pinjam.create', $item->id_buku) }}">
                                @csrf
                                <button type="submit" class="small-button" onclick="return confirm('Apakah Anda yakin ingin meminjam buku ini?')">
                                    <i class="fa fa-plus" style="margin-left: 20px;"></i>
                                </button>
                            </form>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="alert alert-danger">
                                Belum Ada Buku yang Dapat Dipinjam
                            </div>
                        </td>
                    </tr>
                    @endforelse
